...
class CustomSortTest(unittest.TestCase):
    ...
    def test_typical_use_case(self):
        ...
        self.assertEquals(custom_sort(stuff), expected)

    def test_JSON_typical_use_case(self): # You could dump a JSON file with a meaningful order
        expected = """{
            "firstName": "John", 
            "lastName": "Smith", 
            "isAlive": true, 
        ...
        custom_sort = make_custom_sort(orders)
        self.assertEquals(json.dumps(custom_sort(stuff), indent=4), expected)

    def test_no_order_for_some_dict(self):
    ...
    def test_no_order_for_some_keys(self):
    ...
    def test_no_key_for_some_orders(self):
        new_orders = orders[:] + ["foobar"]
        custom_sort = make_custom_sort(new_orders)
        expected = OrderedDict([
            ('firstName', 'John'),
            ('lastName', 'Smith'),
    ...
    def test_no_order_for_some_keys_and_no_key_for_some_orders(self):
        new_orders = [orders[0][:2] + orders[0][5:], orders[1], orders[2], "foobar"]
        custom_sort = make_custom_sort(new_orders)
        expected = OrderedDict([
            ('firstName', 'John'),
            ('lastName', 'Smith'),
    ...
    def test_deep_sorted_copy(self):
        ...
        del expected["Alice"]
        expected["Eve"].add("D")
        self.assertEquals(expected, OrderedDict([('Bob', [1,2,3,6]), ('Oscar', 5), ('Eve', set("ABCD"))]))
        self.assertEquals(stuff, {"Alice": 1, "Bob": [1,2,3], "Eve": set("ABC"), "Oscar": 4})
